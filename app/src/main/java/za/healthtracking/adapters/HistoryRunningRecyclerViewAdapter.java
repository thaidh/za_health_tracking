...
public class HistoryRunningRecyclerViewAdapter extends RecyclerView.Adapter<HistoryRunningRecyclerViewAdapter.DataObjectHolder> {
    private List<RunningBucket> mItems = new ArrayList<>();
    ...
    public HistoryRunningRecyclerViewAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        RunningBucket item = getItem(position);
        ...
        int heightDp = (int)(item.getDuration()/ RunningBucket.MAX_DURATION * MAX_HEIGHT);
    ...
    public RunningBucket getItem(int pos) {
        if (pos < mItems.size())
    ...
    public void updateData(List<RunningBucket> items) {
        mItems = items;
        notifyDataSetChanged();
    }
    ...
    public RunningBucket getSelectedItem() {
